...
from opensearch-benchmark import exceptions, doc_link
from opensearch-benchmark.utils import console, convert
...
class OsClientFactory:
    ...
    def create_async(self):
        # pylint: disable=import-outside-toplevel
        import elasticsearch
        import opensearch-benchmark.async_connection
        import io
        import aiohttp
        ...
        return BenchmarkAsyncOpenSearch(hosts=self.hosts,
                                       connection_class=opensearch-benchmark.async_connection.AIOHttpConnection,
