...
from opensearch-benchmark import paths
from opensearch-benchmark.utils import git, io
...
def minimum_os_version():
    ...
    """
    return resources.read_text("opensearch-benchmark", "min-os-version.txt").strip()
