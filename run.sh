...
install_opensearch-benchmark_with_setuptools () {
...
then
    ...
    install_opensearch-benchmark_with_setuptools "${BENCHMARK_BIN}"
    ...
    install_opensearch-benchmark_with_setuptools "${BINARY_NAME}"
