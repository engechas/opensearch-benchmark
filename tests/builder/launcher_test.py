...
from opensearch-benchmark import config, exceptions, telemetry
from opensearch-benchmark.builder import launcher, cluster
from opensearch-benchmark.builder.provisioner import NodeConfiguration
from opensearch-benchmark.metrics import InMemoryMetricsStore
...
class ProcessLauncherTests(TestCase):
    ...
    @mock.patch('opensearch-benchmark.builder.java_resolver.java_home', return_value=(12, "/java_home/"))
    @mock.patch('opensearch-benchmark.utils.jvm.supports_option', return_value=True)
    @mock.patch('opensearch-benchmark.utils.io.get_size')
    @mock.patch('os.chdir')
    @mock.patch('opensearch-benchmark.builder.launcher.wait_for_pidfile', return_value=MOCK_PID_VALUE)
...
class DockerLauncherTests(TestCase):
    ...
    @mock.patch("opensearch-benchmark.utils.process.run_subprocess_with_output")
    ...
    @mock.patch("opensearch-benchmark.telemetry.add_metadata_for_node")
    @mock.patch("opensearch-benchmark.utils.process.run_subprocess_with_logging")
