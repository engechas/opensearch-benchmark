...
from opensearch-benchmark.builder import provisioner, provision_config
...
class DockerProvisionerTests(TestCase):
    ...
    def test_provisioning_with_defaults(self, uuid4):
        ...
        benchmark_root = os.path.normpath(os.path.join(os.path.dirname(os.path.realpath(__file__)), os.pardir, os.pardir, "opensearch-benchmark"))
