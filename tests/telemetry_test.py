...
from opensearch_benchmark import config, metrics, exceptions, telemetry
from opensearch_benchmark.builder import cluster
...
class StartupTimeTests(TestCase):
    @mock.patch("opensearch_benchmark.time.StopWatch")
    @mock.patch("opensearch_benchmark.metrics.OsMetricsStore.put_value_node_level")
...
class HeapdumpTests(TestCase):
    @mock.patch("opensearch_benchmark.utils.process.run_subprocess_with_logging")
...
class CcrStatsRecorderTests(TestCase):
    ...
    @mock.patch("opensearch_benchmark.metrics.OsMetricsStore.put_doc")
...
class TestSearchableSnapshotsStats:
    ...
    def test_no_metrics_if_no_searchable_snapshots_stats(self, metrics_store_put_doc):
        ...
        logger = logging.getLogger("opensearch_benchmark.telemetry")
...
class NodeStatsTests(TestCase):
    ...
    @mock.patch("opensearch_benchmark.telemetry.NodeStatsRecorder", mock.Mock())
    @mock.patch("opensearch_benchmark.telemetry.SamplerThread", mock.Mock())
...
class TransformStatsRecorderTests(TestCase):
    ...
    @mock.patch("opensearch_benchmark.metrics.OsMetricsStore.put_value_cluster_level")
...
class ClusterEnvironmentInfoTests(TestCase):
    @mock.patch("opensearch_benchmark.metrics.OsMetricsStore.add_meta_info")
...
class NodeEnvironmentInfoTests(TestCase):
    @mock.patch("opensearch_benchmark.metrics.OsMetricsStore.add_meta_info")
    @mock.patch("opensearch_benchmark.utils.sysstats.os_name")
    @mock.patch("opensearch_benchmark.utils.sysstats.os_version")
    @mock.patch("opensearch_benchmark.utils.sysstats.logical_cpu_cores")
    @mock.patch("opensearch_benchmark.utils.sysstats.physical_cpu_cores")
    @mock.patch("opensearch_benchmark.utils.sysstats.cpu_model")
...
class DiskIoTests(TestCase):
    ...
    @mock.patch("opensearch_benchmark.utils.sysstats.process_io_counters")
    @mock.patch("opensearch_benchmark.metrics.OsMetricsStore.put_value_node_level")
    ...
    @mock.patch("opensearch_benchmark.utils.sysstats.disk_io_counters")
    @mock.patch("opensearch_benchmark.utils.sysstats.process_io_counters")
    @mock.patch("opensearch_benchmark.metrics.OsMetricsStore.put_value_node_level")
...
class IndexSizeTests(TestCase):
    @mock.patch("opensearch_benchmark.utils.io.get_size")
    @mock.patch("opensearch_benchmark.metrics.OsMetricsStore.put_value_node_level")
