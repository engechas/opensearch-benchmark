...
from opensearch_benchmark.workload import loader, workload
...
class WorkloadPreparationTests(TestCase):
    @mock.patch("opensearch_benchmark.utils.io.prepare_file_offset_table")
    ...
    @mock.patch("opensearch_benchmark.utils.io.decompress")
    @mock.patch("os.path.getsize")
    @mock.patch("os.path.isfile")
    ...
    @mock.patch("opensearch_benchmark.utils.io.prepare_file_offset_table")
    @mock.patch("opensearch_benchmark.utils.io.decompress")
    @mock.patch("opensearch_benchmark.utils.net.download")
...
class TemplateSource(TestCase):
    @mock.patch("opensearch_benchmark.utils.io.dirname")
...
class WorkloadSpecificationReaderTests(TestCase):
    ...
    @mock.patch("opensearch_benchmark.workload.loader.register_all_params_in_workload")
