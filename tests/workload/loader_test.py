...
from opensearch-benchmark.workload import loader, workload
...
class WorkloadPreparationTests(TestCase):
    @mock.patch("opensearch-benchmark.utils.io.prepare_file_offset_table")
    ...
    @mock.patch("opensearch-benchmark.utils.io.decompress")
    @mock.patch("os.path.getsize")
    @mock.patch("os.path.isfile")
    ...
    @mock.patch("opensearch-benchmark.utils.io.prepare_file_offset_table")
    @mock.patch("opensearch-benchmark.utils.io.decompress")
    @mock.patch("opensearch-benchmark.utils.net.download")
...
class TemplateSource(TestCase):
    @mock.patch("opensearch-benchmark.utils.io.dirname")
...
class WorkloadSpecificationReaderTests(TestCase):
    ...
    @mock.patch("opensearch-benchmark.workload.loader.register_all_params_in_workload")
